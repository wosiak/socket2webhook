              ...
              return (
                <div key={eventId} className="flex items-center gap-2 p-3 bg-blue-50 rounded-lg border border-blue-200">
                  ...
                  <div className="flex items-center gap-1">
                    {event && (
                      (['call-history-was-created', 'new-message-whatsapp', 'message-ack-whatsapp', 'call-was-created', 'call-is-trying', 'call-was-abandoned', 'call-was-connected', 'new-agent-message-whatsapp', 'new-whatsapp-internal-message', 'mailing-list-was-finished', 'agent-was-logged-out', 'agent-is-idle', 'agent-entered-manual', 'start-snooze-chat-whatsapp', 'finish-chat', 'transfer-chat-whatsapp', 'new-agent-chat-whatsapp', 'call-was-not-answered', 'call-was-amd', 'call-was-answered', 'manual-call-was-qualified', 'manual-call-was-updated'].includes(event.name)) ? (
